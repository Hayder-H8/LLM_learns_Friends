...
class batch_generator():
    def __init__(self , data ,split_ratio , context_size):
        self.data=data
        self.train_data=data[:int(len(data)*split_ratio)]
        self.test_data = data[int(len(data)*split_ratio):]
        self.context_size=context_size
    def generate(self,batch_size , split , device):
